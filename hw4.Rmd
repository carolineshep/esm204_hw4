...
warming_damages <- warming %>%
  mutate(damages_baseline = damages_lm_funct(warming_baseline)) %>% # 1) changes over time w/o pulse
  mutate(damages_pulse = damages_lm_funct(warming_pulse)) %>% # 2) damages over time w/ pulse
...
warming_damages_policy_a <- warming_damages %>%
  ...
  mutate(damages_2 = damages_lm_funct(1.5*warming_baseline)) %>%
...
warming_damages_policy_b <- warming_damages_policy_b %>%
  mutate(damages_b = damages_lm_funct(warming_baseline)) %>%
